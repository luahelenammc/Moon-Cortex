...
**Status:** public pre-release · [open the canonical entry](modules/financial-living-system/ADAPTIVE_FINANCE_BOOTSTRAP.md#first-use) · [download the complete portable (.zip)](https://github.com/luahelenammc/Moon-Cortex/raw/refs/heads/main/downloads/financial-living-system.zip?download=1)
