...
- public-safe donor lineage, attribution, licensing and explicit limitations;
- module-specific complete ZIPs as current portable units.

## Outside the public body

The public release excludes:

- private donor corpora and situated source histories;
- personal finance records, balances, debts, statements, account details or transactions;
...
- hidden evaluation data, private resolver logic and protected operational source state;
- claims of adoption, endorsement, validation, savings, social impact, regulatory compliance or institutional readiness that are not supported by public evidence.

## Module-specific exclusions

The Social Support Navigation System specifically does not publish:

- real case histories or live Living Case States;
- identifying health, disability, housing, legal or social-service records;
- real benefit applications, protocols or household documents;
- current resource-pack contacts copied from private cases;
- recognizable donor case sequences under changed names;
- legal conclusions, clinical assessments, eligibility decisions or professional authority.
...
The public body exposes each module’s identity, functional contract, input/output boundary, generalized mechanisms, synthetic examples, validation boundaries and provenance. It does not automatically expose the private resolver, corpus, client logic, case state or operational advantage that produced the generalization.

## Distribution boundary

The repository is the inspectable public body. **Module-specific ZIPs are the current canonical portable units. There is no generic multi-module Cortex package yet.**
